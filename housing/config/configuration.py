...
class Configuration:
    """
    the methods defined here will return entities from housing.entity.config_entity.py.
    """
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            export_dir_path = os.path.join(CURRENT_DIR, model_pusher_config_info[MODEL_PUSHER_MODEL_EXPORT_DIR_KEY],
                                        time_stamp)
    ...
    def get_training_pipeline_config(self) -> TrainingPipelineConfig:
        try:
            ...
            artifact_dir = os.path.join(CURRENT_DIR, 
