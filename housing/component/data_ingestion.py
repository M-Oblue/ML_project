...
class DataIngestion:
    ...
    def download_housing_data(self,) -> str:
        try:
            # accessing remote url to download dataset
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:    
            ...
            with tarfile.open(tgz_file_path) as housing_tgz_obj:
                housing_tgz_obj.extractall(path=raw_data_dir)
            logging.info(f"Extraction successfully completed.")
