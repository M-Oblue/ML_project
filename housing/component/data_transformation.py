...
# creating custom feature transformation class
...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logging.info(f"Obtained training and test file path.")
            schema_file_path = self.data_validation_artifact.schema_file_path
            
            train_df = load_data(file_path=train_file_path, schema_file_path=schema_file_path)
            test_df = load_data(file_path=test_file_path, schema_file_path=schema_file_path)
            logging.info(f"Loaded train and test data as pandas dataframe")
            ...
            logging.info(f"Applying preprocessing object on input training and testing dataframe.")
            input_feature_train_arr = preprocessing_obj.fit_transform(input_feature_train_df)
            input_feature_test_arr = preprocessing_obj.transform(input_feature_test_df)
            
            logging.info(f"Combining input and target feature arrays to form transfomed train and test arrays")
