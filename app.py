...
from housing.constants import CONFIG_DIR, CURRENT_DIR, get_current_time_stamp
...
MODEL_CONFIG_FILE_PATH = os.path.join(CURRENT_DIR, CONFIG_DIR, "model.yaml")
LOG_DIR = os.path.join(CURRENT_DIR, LOG_FOLDER_NAME)
PIPELINE_DIR = os.path.join(CURRENT_DIR, PIPELINE_FOLDER_NAME)
MODEL_DIR = os.path.join(CURRENT_DIR, SAVED_MODELS_DIR_NAME)
